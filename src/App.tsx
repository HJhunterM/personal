  ...
  const qaItems = [
    {
      ...
      answer: 'A: 校招面试时应聘的是服务端岗位，入职后由于业务安排被调到iFinD客户端团队，主要负责金融终端的业务开发。虽然方向和预期有偏差，但这段经历让我积累了宝贵的工程开发经验，同时我也参与了部分服务端工作，比如风控内容审核系统的后端逻辑等。',
    },
    {
      question: 'Q2: 为什么一年后去了华为呢？',
      answer: 'A: Windows客户端与我长期的方向选择不太匹配，当时华为那边有个高性能计算的机会，技术门槛很高，涉及芯片级优化，我觉得是个很难得的学习机会，就去了。虽然方向偏底层，但能接触到高水平的团队和工程规范，对我的技术成长帮助很大。',
    },
    {
      question: 'Q3: 为什么在华为只干了四个月呢？',
      answer: 'A: 我所在的数学库组是刚成立的，成员主要由内部转岗和外部社招组成，还在搭建阶段。年底时组织进行了较大调整，团队发展方向发生变化。综合考虑个人职业规划以及长期发展方向，希望持续深耕服务端开发领域，因此选择离开。',
    },
    {
