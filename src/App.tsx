...
function QA() {
  const qaItems = [
    ...
    },
    {
      ...
      answer: 'A: 虽然职业经历比较曲折，但我真正的后端实战经验主要来自滴滴。在滴滴期间我是Account服务Owner，也是支付核心链路的重要开发者，参与了账户体系、支付链路、分布式事务、性能优化等核心工作。另外在Gap期间我独立完成了高并发秒杀项目，对Redis、Kafka、MySQL、SpringBoot等技术进行了系统实践。我认为自己已经具备独立承担后端业务开发的核心能力。',
    },
    {
